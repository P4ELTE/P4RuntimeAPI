...
{
    P4__V1__SetForwardingPipelineConfigRequest *request;
	...
	/* request->action request->config kell */

    /*
     * Create a reply
     */
/*    P4__V1__SetForwardingPipelineConfigResponse r;
    p4__v1__SetForwardingPipelineConfigResponse__init(&r);
*/
/*    char buf[1024];
    buf[0] = '\0';
    snprintf(buf, 1024, "hello, ");
